...
void main(void)
{
   ...
   printf(" \n");
    ...
    {
        printf(".");
        Sleep(100);//after printing one . another comes after 0.5 seconds
    }
    getch();
    ...
    getch();
    system("cls");*/
   // system("color 3f");//1st is for back ground color and second is for text color
    system("color 3f");
    printf("\n\n");
    printf("\t\t                       __________________________________________________\n");
    printf("\t\t                      |                   CURRENT DATE                   |\n");
    printf("\t\t                      |__________________________________________________|\n");
    printf("\n\n\n\t Enter the date in this format 'mm dd' : ");
    scanf("%d%d",&mm,&dd);
    mm=chkdat(mm,dd);
    start();
}
